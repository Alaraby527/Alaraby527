...
| [wealth-freedom-planner](https://github.com/Alaraby527/wealth-freedom-planner) | 个人财务、任务和副业规划工具 |

## Skill、方法论与知识沉淀

| 仓库 | 内容 |
|---|---|
| [ai-pm-skills](https://github.com/Alaraby527/ai-pm-skills) | 17 个 AI PM Skill 与项目闭环 Workflow |
| [ai-pm-methodology-notes](https://github.com/Alaraby527/ai-pm-methodology-notes) | 用户研究、需求分析、Agent 评测、知识库和 Prompt 方法论 |
| [ai-pm-resume-writing](https://github.com/Alaraby527/ai-pm-resume-writing) | AI PM 简历写作、JD 解析和经历量化 Skill |
...
- **实际投入使用**：有明确使用对象或实际业务场景
- **独立重做**：基于真实业务认知重新设计和实现
- **独立原型**：完成核心流程和评测，但不等同于生产上线
- **模拟评测**：使用模拟数据验证方案和迭代方向
- **学习沉淀**：方法论、Skill、模板或课程资料

部分学习资料和个人工具为私有仓库，面试交流时可按需说明。

## 技术栈

Python · TypeScript · React · Node.js · NestJS · Dify · RAG · Multi-Agent · MCP · 飞书开放平台 · Vercel · Streamlit
